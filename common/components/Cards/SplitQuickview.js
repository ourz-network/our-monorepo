  ...
  return (
    <>
      <Transition.Root show={showQuickview} as={Fragment}>
          <Dialog as="div" className="fixed inset-0 z-50 overflow-y-auto" open={open} onClose={setOpen} static>
                  ...
                  <div className="relative flex items-center w-full px-4 pb-8 overflow-hidden border shadow-2xl bg-dark-background border-dark-border pt-14 sm:px-6 sm:pt-8 md:p-6 lg:p-8">
                    ...
                    <div className="grid items-start w-full grid-cols-1 gap-y-8 gap-x-6 sm:grid-cols-12 lg:gap-x-8">
                      ...
                      <div className="sm:col-span-8 lg:col-span-7">
                        <h1 className="text-lg font-bold text-dark-primary">{split.nickname}</h1>
                        <h2 className="text-sm font-extrabold text-dark-secondary sm:pr-12">{split.id}</h2>
                          <p className="text-2xl text-dark-primary">{split.creations.length} NFT(s) minted</p>
                        ...
                        <section aria-labelledby="options-heading" className="mt-10">
                          <h3 id="options-heading" className="sr-only">
                            ...
                            <div>
                              <h4 className="text-sm font-medium whitespace-pre-wrap text-dark-primary">{split.ETH} ETH unclaimed in Split.</h4>
                            </div>
                            <button
                              type="submit"
