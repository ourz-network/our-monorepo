...
export const OURZ_GRAPH_API_URL_BY_NETWORK = {
  ...
  [Networks.POLYGON]: 'https://api.thegraph.com/subgraphs/name/ourz-network/ourz-v1-polygon',
};
...
export const THEGRAPH_UNISWAP_URL_BY_NETWORK = {
  ...
  [Networks.RINKEBY]: 'https://api.thegraph.com/subgraphs/name/ianlapham/uniswap-v2-rinkeby',
};
