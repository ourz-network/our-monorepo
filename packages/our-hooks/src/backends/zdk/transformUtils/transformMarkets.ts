...
import { getStandardMarketData, MarketResponseFragmentItem } from '../utils/getStandardMarketData';
...
export function transformMarkets(markets: MarketResponseFragmentItem[]) {
  ...
  markets.forEach((market) => {
            ...
            ? {
                ...
                amount: {
                  ...
                  amount: {
                    ...
                    value: market.properties.highestBidPrice.nativePrice.decimal,
                    decimals:
                      market.properties.highestBidPrice.nativePrice.currency.decimals || undefined,
                  },
    ...
    if (market.marketType === ZDKMarketType.V3Ask && market.properties?.__typename === 'V3Ask') {
      marketResponse.push({
        type: MARKET_TYPES.FIXED_PRICE,
