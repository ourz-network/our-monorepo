  ...
  <Global
    styles={css`
      :root {
        ...
        --font-family: var(--${galleryConfig?.fontFamily ?? `sans`});
        --bg-color: ${galleryConfig?.siteBg};
        --preview-bg: ${galleryConfig?.previewBg};
        ...
        --sans: 'Neue Helvetica', 'Neue-Helvetica', 'Helvetica', 'Inter',
          'Arial', sans-serif;
