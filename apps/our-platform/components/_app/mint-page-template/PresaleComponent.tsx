...
import { MintComponent } from '@/components/_app/mint-page-template/MintComponent'
...
export function PresaleComponent({
  ...
  return (
    ...
    //         textAlign='center'
    //       >
    //         The presale window has ended. However, it is still possible to mint
    //         a NFT through the public sale.
    //       </Text>
    //     </Stack>
    //   ) : !address ? (
    //     <Stack align='center'>
    ...
    //         You do not have access to the presale. You may need to use a
    //         different wallet.
    //       </Text>
    //       <Flex mt='x4' w='100%' flexChildren>
